...
footer: Gestion et développement de logiciel libre et open source | :e-mail: sebastien.morais@proton.me
-->
...
**Cours**: 6 séances de 3 heures (pas de TD / TP)
<br/>

**Planning**: 11/09, 18/09, 02/10, 09/10, 16/10, 06/11
<br/>

**Exercice pratique**: contribution à https://github.com/M2-MIAGE-GLL-2026-2027/GLL
<br/>
...
- **CODE_OF_CONDUCT** : fichier fixant les règles de comportement 
  :thought_balloon: Définit un environnement convivial et accueillant, e.g. [ici](https://www.contributor-covenant.org/)
- **AI POLICY** : fichier expliquant les politique et directives relatives à l'utilisation de l'IA, e.g. [ici](https://napari.org/dev/developers/contributing/ai.html)
